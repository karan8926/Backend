...
const {
  ...
  getUniqueAccessCode,
} = require("../controllers/patients_controllers");
const {
  AddTherapist,
  getTherapist,
...
} = require("../controllers/therapist_controllers");
const { loginAdmin, updateAppointmentStatus, triggerLinkOnEmail } = require("../controllers/admin_controllers");
const {
  addCalendarAvailability,
  getCalendarAvailabilityById,
} = require("../controllers/calendar_controllers");
...
router.post('/triggerMail',triggerLinkOnEmail)
...
router.get("/showAllTherapistsNames", showAllTherapistsNames);
